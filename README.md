...
<p align="center">
    <a href="https://github.com/sispopproject/sispop/commits/dev"><img alt="pipeline status" src="https://gitlab.com/sispopproject/sispop/badges/dev/pipeline.svg" /></a>
</p>
...
- GitHub: [https://github.com/sispopproject/sispop](https://github.com/sispopproject/sispop)
- Discord: [https://discord.gg/67GXfD6](https://discord.gg/67GXfD6)

## Vulnerability disclosure

- Check out our [Vulnerability Response Process](https://sispopproject.github.io/sispop-docs/Contributing/VULNERABILITY_RESPONSE_SISPOP), encourages prompt disclosure of any Vulnerabilities
...
`$ git clone --recursive https://github.com/sispopproject/sispop`
...
* Clone Sispop and checkout the most recent release version:
    ...
    ```bash
    git clone https://github.com/sispopproject/sispop.git
    cd sispop
    git checkout master
    ```
...
* To git clone, run:
    ...
    ```bash
    git clone --recursive https://github.com/sispopproject/sispop.git
    ```
...
* If you would like a specific [version/tag](https://github.com/sispopproject/sispop/tags), do a git checkout for that version. eg. 'v5.1.2'. If you don't care about the version and just want binaries from master, skip this step:
