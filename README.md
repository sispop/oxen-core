...
<p align="center">
    <a href="https://github.com/sispop-project/sispop/commits/dev"><img alt="pipeline status" src="https://gitlab.com/sispopproject/sispop/badges/dev/pipeline.svg" /></a>
</p>
...
- GitHub: [https://github.com/sispop-project/sispop](https://github.com/sispop-project/sispop)
- Discord: [https://discord.gg/67GXfD6](https://discord.gg/67GXfD6)

## Vulnerability disclosure

- Check out our [Vulnerability Response Process](https://sispop-project.github.io/sispop-docs/Contributing/VULNERABILITY_RESPONSE_SISPOP), encourages prompt disclosure of any Vulnerabilities

## Information

Sispop is a private cryptocurrency based on Monero. Sispop currently offers an incentivised full node layer, over the coming months we will be looking to support a secondary p2p network (Sispopnet) and a messenger that offers private communications based on the Signal protocol (Sispop Messenger).

More information on the project can be found on the website and in the whitepaper.

Sispop is an open source project, and we encourage contributions from anyone with something to offer. For more information on contributing, please contact team@sispop.network
...
`$ git clone --recursive https://github.com/sispop-project/sispop`
...
Sispop uses the CMake build system and a top-level [Makefile](Makefile) that
...
* Change to the root of the source code directory, change to the most recent release branch, and build:
    ...
    *Note*: The instructions above will compile the most stable release of the
    Sispop software. If you would like to use and test the most recent software,
...
* Install the dependencies for Sispop from the 'Debian' column in the table above.
...
* Clone Sispop and checkout the most recent release version:
    ...
    ```bash
    git clone https://github.com/sispop-project/sispop.git
    cd sispop
    git checkout master
    ```
...
* Then, install the dependencies for Sispop except `libunwind` and `libboost-all-dev`
...
* From here, follow the [general Raspberry Pi instructions](#on-the-raspberry-pi) from the "Clone sispop and checkout most recent release version" step.
...
* To git clone, run:
    ...
    ```bash
    git clone --recursive https://github.com/sispop-project/sispop.git
    ```
...
* If you would like a specific [version/tag](https://github.com/sispop-project/sispop/tags), do a git checkout for that version. eg. 'v5.1.2'. If you don't care about the version and just want binaries from master, skip this step:
...
We expect to add Sispop into the ports tree in the near future, which will aid in managing installations using ports or packages.
...
You will have to add the serialization, date_time, and regex modules to Boost when building as they are needed by Sispop.
