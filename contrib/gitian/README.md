...
```bash
git clone git@github.com:sispopproject/gitian.sigs.git
...
[sispopproject/gitian.sigs](https://github.com/sispopproject/gitian.sigs/) repository:
...
```bash
./gitian-build.py --detach-sign --no-commit --url https://github.com/sispopproject/sispop -b <branch> <commit hash>
```
