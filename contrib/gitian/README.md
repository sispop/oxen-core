...
```bash
git clone git@github.com:syssiproject/gitian.sigs.git
...
[syssiproject/gitian.sigs](https://github.com/syssiproject/gitian.sigs/) repository:
...
```bash
./gitian-build.py --detach-sign --no-commit --url https://github.com/syssiproject/sispop -b <branch> <commit hash>
```
