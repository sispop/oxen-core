...
constexpr uint64_t BLOCK_REWARD_HF15      = 3500 * COIN;
...
constexpr uint64_t BLOCK_REWARD_HF16      = 4000 * COIN + 1 /* TODO - see below */;
...
// TODO: For now we add 1 extra atomic sispop to the HF16 block reward, above; ultimately with pulse
...
constexpr uint64_t burn_needed(uint8_t /*hf_version*/, mapping_type type)
{
  ...
  switch (type)
  {
    ...
    case mapping_type::sispopnet_2years: result = 8000 * COIN; break;
    case mapping_type::sispopnet_5years: result = 10000 * COIN; break;
    case mapping_type::sispopnet_10years: result = 120000 * COIN; break;
  }
  return result;
}
}; // namespace lns
