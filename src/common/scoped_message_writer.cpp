...
#define SISPOP_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/sispop_integration_test_hooks.h"

// NOTE(sispop): This file only exists because I need a way to hook into the
...
// sispop_integration_test_hooks.h functions which isn't possible to expose in
