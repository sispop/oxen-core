...
struct name_system_db
{
  ...
  bool                        validate_lns_tx       (uint8_t hf_version, uint64_t blockchain_height, cryptonote::transaction const &tx, cryptonote::tx_extra_sispop_name_system *entry = nullptr, std::string *reason = nullptr) const;
